...
contract TSwapPoolTest is Test {
    ...
    function testFlawedSwapExactOutput() public {
        ...
        // Some user has 11 pool tokens
        address someUser = makeAddr("someUser");
        uint256 userInitialPoolTokens = 11e18;
        poolToken.mint(someUser, userInitialPoolTokens);
        ...
        // initial liquidity is 1:1, so user should have paid ~1 pool token
        // Hower, it spent much more than that. The user started with 11 tokens, and now has less than 1 pool token
    ...
    function testBreakInvariant() public {
        ...
        // Next swap will break the invariant
